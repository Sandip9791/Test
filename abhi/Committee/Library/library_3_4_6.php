...
<h1 class="text-center">Bibliometrics of the publications based on Scopus/ Web of Science – h-index of the Institution (3.4.6) :</h1>
    ...
    <table class="table table-hover table-bordered border border-success border-3 ">
        <thead class="table-success text-center">
            <tr>
                ...
                <th scope="col">h-index scopus</th>
                <th scope="col">h-index Web of Science</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center"><?= $chapter->h_index_scopus ?> </td>
                            <td class="text-center"><?= $chapter->h_index_Web_of_Science ?> </td>
                            <td class="text-center"><?= $chapter->Calculate ?> </td>

                            <td class="text-center">
                                <form action="<?= base_url('delete_library_3_4_6') ?>" method="post">
                            ...
                            <td>
                                ...
                                <div class="modal fade" id="exampleModal<?= $chapter->Committe_id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable  ">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">3.4.6</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>

                                            <div class="modal-body">
                                                <form action="<?= base_url('update_library_3_4_6') ?>" method="post" enctype="multipart/form-data">
                                                    <div class="row">
                                                        ...
                                                        <div class="md-4">
                                                            <label class="form-label">h-index scopus : <label style="color: red;">*</label></label>
                                                            <input type="number" class="form-control" name="h_index_scopus" value="<?= $chapter->h_index_scopus ?>" id="">
                                                        </div>

                                                        <div class="md-4">
                                                            <label class="form-label">h-index Web of Science :<label style="color: red;">*</label></label>
                                                            <input type="number" class="form-control" name="h_index_Web_of_Science" value="<?= $chapter->h_index_Web_of_Science ?>" id="">
                                                        </div>

                                                        <div class="md-4">
                                                            <label for="">Calculate : </label><br />
                                                            <input type="text" class="form-control" name="Calculate" value="<?= $chapter->Calculate ?>">
                                                        </div>
                                                    </div>
