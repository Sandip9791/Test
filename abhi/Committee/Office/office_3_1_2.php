...
<h1 class="text-center">The institution provides seed money to its teachers for research (3.1.2)</h1>
...
<div class="container-fluid" style="display:none" id="committees">
    <div id="form-container">
        <div class="container-fluid border border-primary border-2 my-3 mx-2">
            <form class="row g-3 my-3" method="post" action="<?= base_url('save_office_3_1_2') ?>" enctype="multipart/form-data">
                ...
                <div class="col-md-8">
                    <label class="form-label">Upload Audited Income-Expenditure statement highlighting the expenditure towards seed money endorsed by the Finance Officer  : <label style="color: red;">*</label></label>
                    <input type="file" class="form-control" name="Upload_the_list" accept=".pdf">
                </div>
    ...
    <table class="table table-hover table-bordered border border-success border-3 ">
        <thead class="table-success text-center">
            <tr>
                ...
                <th scope="col">Audited Income-Expenditure statement highlighting the expenditure towards seed money endorsed by the Finance Officer </th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <?php if (!empty($chapter->Upload_the_list)) : ?>
                                    <a href="<?= base_url('Userfiles/Committee/') . $chapter->Upload_the_list; ?>" download><img src="<?= base_url('assets/images/iconspdf.gif') ?>" width="33px"> <br>
                            ...
                            <td class="text-center">
                                <form action="<?= base_url('delete_office_3_1_2') ?>" method="post">
                            ...
                            <td>
                                ...
                                <div class="modal fade" id="exampleModal<?= $chapter->Committe_id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable  ">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">3.1.2</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>

                                            <div class="modal-body">
                                                <form action="<?= base_url('update_office_3_1_2') ?>" method="post" enctype="multipart/form-data">
                                                    <div class="row">
